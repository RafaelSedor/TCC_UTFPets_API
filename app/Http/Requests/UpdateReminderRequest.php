...
class UpdateReminderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'timezone_override' => 'sometimes|nullable|timezone',
            'snooze_minutes_default' => 'sometimes|integer|min:0|max:1440',
            'active_window_start' => 'sometimes|nullable|date_format:H:i',
            'active_window_end' => 'sometimes|nullable|date_format:H:i|after:active_window_start',
        ];
    }
