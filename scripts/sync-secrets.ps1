...
$vars = @("APP_KEY","JWT_SECRET","DB_HOST","DB_DATABASE","DB_USERNAME","DB_PASSWORD","CLOUDINARY_URL","CLOUDINARY_CLOUD_NAME","CLOUDINARY_API_KEY","CLOUDINARY_API_SECRET","APP_NAME","APP_ENV","APP_DEBUG","DB_PORT")
